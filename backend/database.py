...
MONGODB_DATABASE_NAME = os.getenv("MONGODB_DATABASE_NAME", "pulsecity")
...
async def init_db():
    ...
    try:
        ...
        from models import Camera, Event, Ambulance
        
        await init_beanie(
            database=client[MONGODB_DATABASE_NAME],
            document_models=[Camera, Event, Ambulance]
        )
        ...
        if "timeout" in error_msg.lower() or "timed out" in error_msg.lower():
            ...
            print("2. Verify your IP is whitelisted in Network Access (or use 0.0.0.0/0 for dev)")
